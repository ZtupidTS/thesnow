...
void GFXDebuggerOGL::CreateGUIControls()
{
	...
	// Options
	wxStaticBoxSizer *sOptions = new wxStaticBoxSizer(wxVERTICAL, this, wxT("选项"));
	m_Check[0] = new wxCheckBox(this, ID_SAVETOFILE, wxT("保存到文件"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_Check[1] = new wxCheckBox(this, ID_INFOLOG, wxT("信息日志"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_Check[2] = new wxCheckBox(this, ID_PRIMLOG, wxT("主要日志"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_Check[3] = new wxCheckBox(this, ID_SAVETEXTURES, wxT("保存材质"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_Check[4] = new wxCheckBox(this, ID_SAVETARGETS, wxT("保存目标"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_Check[5] = new wxCheckBox(this, ID_SAVESHADERS, wxT("保存 Shaders"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
