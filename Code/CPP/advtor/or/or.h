...
#define advtor_ver "0.2.0.7"
#define ADVTOR_DW_VER 0x00020007
...
#define LOG_PROTOCOL_WARN (get_options()->ProtocolWarnings ? \
  ...
  char	*Language;
  char	*WindowPos;
  int HotkeyRestore,HotkeyNewIdentity,HotkeyIntercept,HotkeyRelease;
...
struct socks_request_t {
  ...
  char address[MAX_SOCKS_ADDR_LEN]; /**< What address did the client ask to
                                       connect to/resolve? */
  char original_address[MAX_SOCKS_ADDR_LEN];
...
const char __stdcall *GeoIP_getfullname(int countryIndex);
