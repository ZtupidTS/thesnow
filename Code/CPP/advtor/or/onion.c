                  ...
                  char *onion_skin_out) /* ONIONSKIN_CHALLENGE_LEN bytes */
{
  ...
  *handshake_state_out = NULL;
  ...
  if (crypto_pk_public_hybrid_encrypt(dest_router_key, onion_skin_out,ONIONSKIN_CHALLENGE_LEN,
                            ...
                            size_t key_out_len)
{
  ...
  for (i=0;i<2;++i) {
    ...
    len = crypto_pk_private_hybrid_decrypt(k, challenge,ONIONSKIN_CHALLENGE_LEN,
