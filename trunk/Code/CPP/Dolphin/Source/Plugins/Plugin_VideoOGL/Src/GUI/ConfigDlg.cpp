...
void GFXConfigDialogOGL::CreateGUIControls()
{
	...
	m_RenderToMainWindow = new wxCheckBox(m_PageGeneral, ID_RENDERTOMAINWINDOW, wxT("附加于主窗口"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_RenderToMainWindow->SetValue(g_Config.RenderToMainframe);
	m_NativeResolution = new wxCheckBox(m_PageGeneral, ID_NATIVERESOLUTION, wxT("原始"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	...
	m_UseXFB = new wxCheckBox(m_PageGeneral, ID_USEXFB, wxT("使用真实 XFB"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_AutoScale = new wxCheckBox(m_PageGeneral, ID_AUTOSCALE, wxT("Auto scale (尝试移除边框)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	m_WidescreenHack = new wxCheckBox(m_PageGeneral, ID_WIDESCREENHACK, wxT("宽屏破解"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	...
	m_VSync = new wxCheckBox(m_PageGeneral, ID_VSYNC, wxT("垂直同步 (需要重启)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	...
	m_ShaderErrors = new wxCheckBox(m_PageAdvanced, ID_SHADERERRORS, wxT("显示光影兼容问题"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	...
	sbHacks = new wxStaticBoxSizer(wxVERTICAL, m_PageAdvanced, wxT("破解"));
