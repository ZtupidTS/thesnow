...
void wxCheatsWindow::Init_ChildControls()
{
	...
	// Button Strip
	wxButton* const button_apply = new wxButton(panel, wxID_ANY, _T("应用"), wxDefaultPosition, wxDefaultSize);
	_connect_macro_(button_apply, wxCheatsWindow::OnEvent_ApplyChanges_Press, wxEVT_COMMAND_BUTTON_CLICKED, this);
	wxButton* const button_close = new wxButton(panel, wxID_ANY, _T("关闭"), wxDefaultPosition, wxDefaultSize);
