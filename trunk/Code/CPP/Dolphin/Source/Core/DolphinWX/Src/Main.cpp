...
bool DolphinApp::OnInit()
{
	...
	// Parse command lines
		...
		wxCmdLineEntryDesc cmdLineDesc[] =
		{
			...
			{
				wxCMD_LINE_SWITCH, _("d"), _("debugger"), wxT("打开调试器")
			},
			{
				wxCMD_LINE_SWITCH, _("l"), _("logger"), wxT("打开记录器")
			},
			{
				wxCMD_LINE_OPTION, _("e"), _("elf"), wxT("载入 elf 文件"),
				wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL
			},
			{
				wxCMD_LINE_OPTION, _("V"), _("video_plugin"), wxT("指定视频插件"),
				wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL
			},
			{
				wxCMD_LINE_OPTION, _("A"), _("audio_plugin"), wxT("指定音频插件"),
				wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL
			},
			{
				wxCMD_LINE_OPTION, _("P"), _("pad_plugin"), wxT("指定手柄插件"),
				wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL
			},
			{
				wxCMD_LINE_OPTION, _("W"), _("wiimote_plugin"), wxT("指定 wiimote 插件"),
				wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL
			},
			{
				wxCMD_LINE_NONE
	...
	// Create the window title
		...
		#else
			const WCHAR *title = wxT("Dolphin -恒久快乐,经典永远-");
		#endif
		#endif
	#endif
