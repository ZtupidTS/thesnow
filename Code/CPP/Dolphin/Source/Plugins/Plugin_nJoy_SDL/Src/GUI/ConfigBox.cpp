...
void PADConfigDialognJoy::CreateGUIControls()
{
	...
	// Buttons
	m_About = new wxButton(this, ID_ABOUT, wxT("关于"), wxDefaultPosition, wxSize(75, 25), 0, wxDefaultValidator, wxT("About"));
	m_OK = new wxButton(this, ID_OK, wxT("确定"), wxDefaultPosition, wxSize(75, 25), 0, wxDefaultValidator, wxT("OK"));
	m_Cancel = new wxButton(this, ID_CANCEL, wxT("取消"), wxDefaultPosition, wxSize(75, 25), 0, wxDefaultValidator, wxT("Cancel"));
	m_OK->SetToolTip(
	...
	for(int i = 0; i < 4; i++)
	{
		...
		/* You can enable the bitmap here. But it loads 黚erslow on init... (only in windows, linux
		...
		m_textDpadUp[i] = new wxStaticText(m_pKeys[i], IDT_DPAD_UP, wxT("上"), wxPoint(l + 6, t + DPt + 36*0), wxDefaultSize, 0, wxT("上"));
		m_textDpadDown[i] = new wxStaticText(m_pKeys[i], IDT_DPAD_DOWN, wxT("下"), wxPoint(l + 6, t + DPt + 36*1), wxDefaultSize, 0, wxT("下"));
		m_textDpadLeft[i] = new wxStaticText(m_pKeys[i], IDT_DPAD_LEFT, wxT("左"), wxPoint(l + 6, t + DPt + 36*2), wxDefaultSize, 0, wxT("左"));
		m_textDpadRight[i] = new wxStaticText(m_pKeys[i], IDT_DPAD_RIGHT, wxT("右"), wxPoint(l + 6, t + DPt + 36*3), wxDefaultSize, 0, wxT("右"));
		...
		m_gJoyname[i] = new wxStaticBoxSizer (wxHORIZONTAL, m_Controller[i], wxT("控制器"));
		...
		m_gExtrasettings[i] = new wxStaticBoxSizer( wxVERTICAL, m_Controller[i], wxT("附加设置"));
		...
		// The drop down menu
		m_gStatusInSettings[i] = new wxStaticBoxSizer( wxVERTICAL, m_Controller[i], wxT("Main-stick 设置"));
		m_gStatusInSettingsRadiusH[i] = new wxBoxSizer(wxHORIZONTAL);
		m_gStatusInSettingsC[i] = new wxStaticBoxSizer( wxVERTICAL, m_Controller[i], wxT("C-stick 设置"));
		...
		m_gStatusAdvancedSettings[i] = new wxStaticBoxSizer( wxVERTICAL, m_Controller[i], wxT("高级设置"));
