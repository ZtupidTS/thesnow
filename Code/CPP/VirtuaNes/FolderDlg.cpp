...
//	DEBUGOUT( "CFolderDlg::OnOK\n" );
	...
	PathCheck( (LPSTR)Config.path.szRomPath );
	PathCheck( (LPSTR)Config.path.szSavePath );
	PathCheck( (LPSTR)Config.path.szStatePath );
	PathCheck( (LPSTR)Config.path.szSnapshotPath );
	PathCheck( (LPSTR)Config.path.szMoviePath );
	PathCheck( (LPSTR)Config.path.szWavePath );
	PathCheck( (LPSTR)Config.path.szCheatPath );
	PathCheck( (LPSTR)Config.path.szIpsPath );
...
//	DEBUGOUT( "CFolderDlg::OnSaveBrowse\n" );
	...
	::GetDlgItemTextA( m_hWnd, IDC_FLD_SAVE_EDIT, szTemp, _MAX_PATH );

	CHAR	szFolder[_MAX_PATH];
	string	pathstr = CPathlib::CreatePath( (LPCSTR)CApp::GetModulePath(), szTemp );
	::lstrcpyA( szFolder, pathstr.c_str() );
DEBUGOUT( "Path:%s\n", szFolder );

	CHAR	szTitle[256];
	CApp::LoadString( IDS_UI_BROWSE, (LPTSTR)szTitle, sizeof(szTitle) );

	if( CPathlib::SelectFolder( m_hWnd, szTitle, szFolder ) ) {
		::SetDlgItemTextA( m_hWnd, IDC_FLD_SAVE_EDIT, szFolder );
...
//	DEBUGOUT( "CFolderDlg::OnSnapshotBrowse\n" );
	CHAR	szTemp[_MAX_PATH];
	::GetDlgItemTextA( m_hWnd, IDC_FLD_SNAPSHOT_EDIT, szTemp, _MAX_PATH );
...
DEBUGOUT( "Path:%s\n", szFolder );
	...
	if( CPathlib::SelectFolder( m_hWnd, szTitle, szFolder ) ) {
		::SetDlgItemTextA( m_hWnd, IDC_FLD_SNAPSHOT_EDIT, szFolder );
...
//	DEBUGOUT( "CFolderDlg::OnMovieBrowse\n" );
	CHAR	szTemp[_MAX_PATH];
	::GetDlgItemTextA( m_hWnd, IDC_FLD_MOVIE_EDIT, szTemp, _MAX_PATH );
...
DEBUGOUT( "Path:%s\n", szFolder );
	...
	if( CPathlib::SelectFolder( m_hWnd, szTitle, szFolder ) ) {
		::SetDlgItemTextA( m_hWnd, IDC_FLD_MOVIE_EDIT, szFolder );
...
//	DEBUGOUT( "CFolderDlg::OnWaveBrowse\n" );
	CHAR	szTemp[_MAX_PATH];
	::GetDlgItemTextA( m_hWnd, IDC_FLD_WAVE_EDIT, szTemp, _MAX_PATH );
...
DEBUGOUT( "Path:%s\n", szFolder );
	...
	if( CPathlib::SelectFolder( m_hWnd, szTitle, szFolder ) ) {
		::SetDlgItemTextA( m_hWnd, IDC_FLD_WAVE_EDIT, szFolder );
...
//	DEBUGOUT( "CFolderDlg::OnCheatBrowse\n" );
	CHAR	szTemp[_MAX_PATH];
	::GetDlgItemTextA( m_hWnd, IDC_FLD_CHEAT_EDIT, szTemp, _MAX_PATH );
...
DEBUGOUT( "Path:%s\n", szFolder );
	...
	if( CPathlib::SelectFolder( m_hWnd, szTitle, szFolder ) ) {
		::SetDlgItemTextA( m_hWnd, IDC_FLD_CHEAT_EDIT, szFolder );
...
//	DEBUGOUT( "CFolderDlg::OnIpsBrowse\n" );
	CHAR	szTemp[_MAX_PATH];
	::GetDlgItemTextA( m_hWnd, IDC_FLD_IPS_EDIT, szTemp, _MAX_PATH );
...
DEBUGOUT( "Path:%s\n", szFolder );
	...
	if( CPathlib::SelectFolder( m_hWnd, szTitle, szFolder ) ) {
		::SetDlgItemTextA( m_hWnd, IDC_FLD_IPS_EDIT, szFolder );
