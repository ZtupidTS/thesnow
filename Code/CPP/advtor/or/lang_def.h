...
{LANG_STR_FRAME4,"Some applications have installed extensions / scripting languages capable to bypass proxy restrions" \
	" to make the application reveal your real IP. " \
	"This is an attempt to force specific applications and all their extensions to always use TOR. " \
	"To do this, the application is intercepted and Winsock calls are redirected to AdvTor.dll. " \
	"This feature is experimental, it may not work on your system and it may cause system instability. Use at your own risk." \
	"\r\nSelect the checkbox near the process you want to be sure it cannot bypass TOR."},
...
{LANG_MB_IDENTITY_DIFFERENT_IP,"All new connections will appear from different IP"},
...
{LANG_LB_FORCE_TOR,"Force TOR *BETA*"},
{LANG_LB_SERVER,"Become a Server"},
{LANG_LB_DEBUG,"Debug"},
{LANG_LB_ABOUT,"About"},
{LANG_LB_BRIDGES,"Bypass ISP filtering"},
{LANG_LB_NETSTAT,"Network information"},
{LANG_LB_PLUGINS,"Plugins"},
{LANG_LB_RESERVED4,NULL},
{LANG_DLG_START_TOR,"&Start Tor"},
...
{LANG_DLG_EXIT,"E&xit"},
{LANG_DLG_SAVE_TO_LOG,"Save to AdvTor.&log"},
...
{LANG_DLG_START_AUTOMATICALLY,"Start Tor automatically"},
...
{LANG_DLG_CHANGE_PROCESS_ICON,"Change program icon to indicate AdvTor.dll presence"},
...
{LANG_DLG_LOCAL_PROXY_PORT,"Local proxy port:"},
{LANG_DLG_LOCAL_PROXY_ADDR,"Local address:"},
...
{LANG_DLG_DISALLOWED_CONNECTIONS,"Restricted / disallowed connections"},
{LANG_DLG_BANNED_PORTS,"Banned ports (port1,port2,...):"},
{LANG_DLG_BANNED_HOSTS,"Banned websites:"},
...
{LANG_DLG_CIRCUIT_TIMEOUT_EXIT,"Circuit timeout when exiting program (seconds):"},
...
{LANG_DLG_FORCED_EXIT_HOSTS,"Forced exit nodes (website newaddress)"},
{LANG_DLG_NODE_FAMILIES,"Node families (node1,node2,...)"},
{LANG_DLG_TRACKED_HOSTS,"Use same exit for these hosts if possible (tracked hosts):"},
...
{LANG_DLG_BANNED_NODES,"Banned nodes"},
{LANG_DLG_FAVORITE_NODES,"Favorite nodes ([E|X] nickname|hash)"},
...
{LANG_DLG_HS_VERSION_0,"Version 0"},
{LANG_DLG_HS_VERSION_2,"Version 2"},
{LANG_DLG_HS_VERSION_ALL,"All versions"},
...
{LANG_PF_DLG_TITLE,"Advanced Tor Process Finder"},
{LANG_PF_DLG_HELP,"Drag this object over the window created by a process you want to be forced to use Tor:"},
{LANG_PF_DLG_FORCE,"&Force TOR"},
...
{LANG_LOG_BUFFERS_CLEAN_FREELIST,"Cleaning freelist for %d-byte chunks: keeping %d, dropping %d."},
...
{LANG_LOG_BUFFERS_SOCKS_IP_WARN,"Your application (using socks5 to port %d) is giving Tor only an IP address. Applications that do DNS resolves themselves may leak information. Consider using Socks4A (e.g. via privoxy or socat) instead. For more information, please see http://wiki.noreply.org/noreply/TheOnionRouter/TorFAQ#SOCKSAndDNS.%s"},
...
{LANG_LOG_CONFIG_SWITCHING_TO_ENTRY_GUARDS,"Switching to entry guards; abandoning previous circuits"},
{LANG_LOG_CONFIG_BRIDGE_STATUS_CHANGED,"Bridge status changed.  Forgetting GeoIP stats."},
...
{LANG_LOG_CONFIG_DEFAULT_NICKNAME_ERROR,"Couldn't pick a nickname based on our hostname; using %s instead."},
...
{LANG_LOG_CONFIG_ORPORT_OUT_OF_BOUNDS,"ORPort option out of bounds."},
...
{LANG_LOG_CONFIG_SOCKSPORT_OUT_OF_BOUNDS,"SocksPort option out of bounds."},
{LANG_LOG_CONFIG_DNSPORT_OUT_OF_BOUNDS,"DNSPort option out of bounds."},
{LANG_LOG_CONFIG_TRANSPORT_OUT_OF_BOUNDS,"TransPort option out of bounds."},
{LANG_LOG_CONFIG_NATDPORT_OUT_OF_BOUNDS,"NatdPort option out of bounds."},
{LANG_LOG_CONFIG_CONTROLPORT_OUT_OF_BOUNDS,"ControlPort option out of bounds."},
{LANG_LOG_CONFIG_DIRPORT_OUT_OF_BOUNDS,"DirPort option out of bounds."},
...
{LANG_LOG_CONFIG_HTTPPROXYAUTHENTICATOR_TOO_LONG,"HttpProxyAuthenticator is too long (>= 48 chars)."},
{LANG_LOG_CONFIG_HTTPSPROXY_PARSE_FAILED,"HttpsProxy failed to parse or resolve. Please fix."},
{LANG_LOG_CONFIG_HTTPSPROXYAUTHENTICATOR_TOO_LONG,"HttpsProxyAuthenticator is too long (>= 48 chars)."},
...
{LANG_LOG_CONFIG_PREFERTUNNELDIRCONNS_WITHOUT_TUNNELDIRCONNS,"Must set TunnelDirConns if PreferTunneledDirConns is set."},
...
{LANG_LOG_CONNECTION_TOO_MANY_CONNS,"Failing because we have %d connections already. Please raise your ulimit -n."},
...
{LANG_LOG_CONTROL_BS_CONNECTED,"Connected to TOR network."},
...
{LANG_LOG_DIR_HTTP_503,"Server at '%s:%d' sent us a 503 response, but included a body anyway. We'll pretend it gave us a 200."},
...
{LANG_LOG_DIR_HTTP_ERROR_19,"http status 503 (%s) response from dirserver '%s:%d'. Node is (currently) not acting as v2 hidden service directory."},
...
{LANG_LOG_DIRSERV_ROUTER_REACHABLE,"Found router %s to be reachable. Yay."},
...
{LANG_LOG_DIRVOTE_UNKNOWN_VOTER,"We do not know about %s"},
...
{LANG_LOG_DIRVOTE_CONSENSUS_INSUFFICIENT_INFO,"Not enough info to publish pending consensus"},
{LANG_LOG_DIRVOTE_CONSENSUS_PUBLISH_FAILED,"Error publishing consensus"},
{LANG_LOG_DIRVOTE_CONSENSUS_PUBLISH_OK,"Consensus published."},
...
{LANG_LOG_DLG_VERSION_TOO_OLD,"This version of AdvTor requires AdvTor.dll version 0.1.0.7 or higher."},
{LANG_LOG_DLG_ERROR_LOADING_DLL,"Error loading %s. Some features, like \"Force TOR\" will be unavailable."},
{LANG_LOG_DLG_WELCOME,"\r\n\r\n\t\tAdvanced TOR v%s\r\n\r\n\tClick \"Start Tor\" to connect to OR network.\r\n\t"\
		"These are the proxy settings you can use:\r\n\t\tAddress: 127.0.0.1\r\n\t\tPort: %d\r\n\t\t127.0.0.1:%d\r\n\t"\
		"Use \"Force TOR\" to be sure that your proxy settings are always used.\r\n\r\n\t"\
		"For feature requests and bug reports use one of the following forums:\r\n\t\t"\
		"http://nemesis.te-home.net/Forum/2350_Advanced_TOR/\r\n\t\t"\
		"http://forum.meka-meka.com/forum.php?f=advtor\r\n\t\t"\
		"http://sourceforge.net/projects/advtor/forums\r\n\t"\
		"WARNING: Advanced TOR is an UNOFFICIAL CLIENT.\r\n\t"\
		"To get a client supported by torproject.org visit https://torproject.org .\r\n"},
...
{LANG_LOG_DNS_TEST_ADDRESS_REJECTED,"eventdns rejected test address %s: error %d"},
...
{LANG_LOG_DNSSERV_REQUEST_NOT_SUPPORTED,"None of the questions we got were ones we're willing to support. Sending NODATA."},
...
{LANG_LOG_MAIN_CELL_STATS,"Cells processed: %I64u padding\n"\
		"                 %I64u create\n"\
		"                 %I64u created\n"\
		"                 %I64u relay\n"\
		"                        (%I64u relayed)\n"\
...
{LANG_LOG_RENDSERVICE_CLOSING_INTRO_POINT,"Closing intro point %s for service %s version %d."},
...
{LANG_LOG_ROUTER_ERROR_PARSING_EXTRAINFO,"We just generated an extrainfo descriptor we can't parse. Descriptor was: <<%s>>"},
...
{LANG_LOG_TLS_OPENSSL,"OpenSSL %s looks like version 0.9.8l; I will try SSL3_FLAGS to enable renegotation."},
...
{LANG_DLL_ERROR_1,"Current version of AdvTor cannot intercept processes on your system."},
...
{LANG_DLL_ERROR_5,"Error loading AdvTor.dll in selected process, code: "},
...
{LANG_DLL_RESOLVE," tryes to resolve the address "},
...
{LANG_DLL_PIPEINUSE,"There was an error creating AdvTor pipe. If there is another instance of same AdvTor, close it and try again."},
...
{LANG_BRIDGES_AVOID_DIRS,"Avoid directories that don't support encrypted connections"},
{LANG_BRIDGES_HTTP_PROXY,"All HTTP directory requests will use this HTTP proxy:"},
{LANG_BRIDGES_HTTPS_PROXY,"All TLS (SSL) connectinos will use this HTTPS proxy:"},
...
{LANG_DLL_REINTERCEPT," - connection request for an address that was not found in AdvTor.dll's onion cache. This can happen when a process is re-intercepted and it keeps its own DNS cache with fake IPs given by previous instances of AdvTor.dll. You can wait until program's cache expires or you can restart the program."},
{LANG_DLL_JUNKDATA,"An application is sending junk through AdvTor pipe. The following data was received:\r\n"},
{LANG_DLL_CONNECTIONS_1," - the application was intercepted successfully, but it already has existing opened connections that do not go through Tor network. The following connections were found:"},
{LANG_DLL_CONNECTIONS_2,"Do you want to close these connections ?"},
{LANG_LOG_BUFFERS_FROM_HTTP_HOST,"A non-proxy HTTP request was sent for address %s. If your application is intercepted, something is blocking AdvTor.dll (known issue with Nod32)."},
...
{LANG_PLUGINS_RIGHTS_SETTINGS,"Save settings to AdvTor.ini"},
...
{LANG_DLG_SYSTEM_HOTKEY_RESTORE,"Hide / restore Advanced TOR window"},
...
{LANG_MB_INTERCEPT_FAIL,"There was an error when trying to intercept some functions from the process %s. This usually happens if AdvTor was started from a restricted account."},
