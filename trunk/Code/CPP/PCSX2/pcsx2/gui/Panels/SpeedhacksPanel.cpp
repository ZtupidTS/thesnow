 ...
 : BaseApplicableConfigPanel_SpecificConfig( parent )
{
	...
	m_check_Enable->SetToolTip(_("为了更好的兼容性,可能需要关闭游戏加速.")).SetSubPadding( 1 );
	...
	wxPanelWithHelpers* eeSliderPanel = new wxPanelWithHelpers( left, wxVERTICAL, _("EE 循环速率 [Not Recommended]") );
	...
	wxPanelWithHelpers* vuSliderPanel = new wxPanelWithHelpers( right, wxVERTICAL, _("VU 循环速率欺骗 [Not Recommended]") );
	...
	m_check_vuBlockHack = new pxCheckBox( vuHacksPanel, _("mVU Block 破解"),
	...
	m_check_waitloop = new pxCheckBox( miscHacksPanel, _("启用等待循环检测"),
		_("Moderate speedup for some games, with no known side effects. [推荐]" ) );

	m_check_fastCDVD = new pxCheckBox( miscHacksPanel, _("启用快速启动"),
