...
void CLogWindow::CreateGUIControls()
{
	...
	m_writeFileCB = new wxCheckBox(this, IDM_WRITEFILE, wxT("写入到文件"), wxDefaultPosition, wxDefaultSize, 0);
	m_writeConsoleCB = new wxCheckBox(this, IDM_WRITECONSOLE, wxT("写入到控制台"), wxDefaultPosition, wxDefaultSize, 0);
	m_writeWindowCB = new wxCheckBox(this, IDM_WRITEWINDOW, wxT("写入到窗口 ->"), wxDefaultPosition, wxDefaultSize, 0);
	...
	sLogCtrl->Add(new wxButton(this, IDM_TOGGLEALL, wxT("切换所有"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT), 1);
	sLogCtrl->Add(new wxButton(this, IDM_CLEARLOG, wxT("清除"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT), 1);
