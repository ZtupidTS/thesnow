...
lang_procs	macro
msg1	db	'Current version of AdvTor cannot intercept processes on your system.',0
...
msg5	db	'Error loading AdvTor.dll in selected process, code: ',0
...
msgnr	db	' tryes to resolve the address ',0
...
pipeinuse db	'There was an error creating AdvTor pipe. If there is another instance of same AdvTor, close it and try again.',0
reintercept db	' - connection request for an address that was not found in AdvTor.dll',39,'s onion cache. This can happen when a process is re-intercepted '
	db	'and it keeps its own DNS cache with fake IPs given by previous instances of AdvTor.dll. You can wait until programs',39,'s cache expires or you can restart the program.',0
junkdata db	'An application is sending junk through AdvTor pipe. The following data was received:',13,10,0
openconns db	' - the application was intercepted successfully, but it already has existing opened connections that do not go through Tor network. The following connections were found:',0
