...
Panels::eeLogOptionsPanel::eeLogOptionsPanel( LogOptionsPanel* parent )
	: BaseCpuLogOptionsPanel( parent, L"EE 日志" )
{
	SetMinWidth( 300 );

	m_miscGroup		= new wxStaticBoxSizer( wxVERTICAL, this, L"常规" );

	m_disasmPanel	= new CheckedStaticBox( this, wxVERTICAL, L"反汇编" );
	m_hwPanel		= new CheckedStaticBox( this, wxVERTICAL, L"寄存器" );
...
Panels::iopLogOptionsPanel::iopLogOptionsPanel( LogOptionsPanel* parent )
	: BaseCpuLogOptionsPanel( parent, L"IOP 日志" )
{
	SetMinWidth( 280 );
...
{
	wxStaticBoxSizer&	s_misc		= *new wxStaticBoxSizer( wxHORIZONTAL, this, L"其它" );
