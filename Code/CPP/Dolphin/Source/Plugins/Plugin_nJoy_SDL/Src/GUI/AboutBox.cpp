...
void AboutBox::CreateGUIControls()
{
	...
	m_OK = new wxButton(this, ID_OK, wxT("确定"), wxPoint(116,343), wxSize(75,25), 0, wxDefaultValidator, wxEmptyString);
	...
	m_pluginversiongroup = new wxStaticBox(this, IDG_PLUGINVERSION, wxT("插件信息:"), wxPoint(10,61), wxSize(180,68));
