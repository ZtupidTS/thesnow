...
void PADConfigDialognJoy::PadGetStatus()
{
	...
	{
		m_TStatusIn[notebookpage]->SetLabel(wxT("未连接")); m_TStatusOut[notebookpage]->SetLabel(wxT("未连接"));
		m_TStatusInC[notebookpage]->SetLabel(wxT("未连接")); m_TStatusOutC[notebookpage]->SetLabel(wxT("未连接"));
		m_TStatusTriggers[notebookpage]->SetLabel(wxT("未连接"));
		return;
	}
