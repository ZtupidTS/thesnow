...
BOOL CSetACLCtrl::CSetACLCtrlFactory::UpdateRegistry (BOOL bRegister)
{
	if (bRegister)
	{
		return AfxOleRegisterControlClass (AfxGetInstanceHandle (), m_clsid, m_lpszProgID, IDS_SETACL, IDB_SETACL, afxRegApartmentThreading, _dwSetACLOleMisc, _tlid, _wVerMajor, _wVerMinor);
	}
	else
	{
