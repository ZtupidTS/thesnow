...
void CPatchAddEdit::CreateGUIControls(int _selection)
{
	...
	wxStaticText* EditPatchNameText = new wxStaticText(this, ID_EDITPATCH_NAME_TEXT, _("名称:"), wxDefaultPosition, wxDefaultSize);
	...
	wxStaticText* EditPatchOffsetText = new wxStaticText(this, ID_EDITPATCH_OFFSET_TEXT, _("偏移量:"), wxDefaultPosition, wxDefaultSize);
	...
	EditPatchType = new wxRadioBox(this, ID_EDITPATCH_TYPE, _("类型"), wxDefaultPosition, wxDefaultSize, wxArrayStringFor_EditPatchType, 3, wxRA_SPECIFY_COLS, wxDefaultValidator);
	EditPatchType->SetSelection((int)tempEntries.at(0).type);
	wxStaticText* EditPatchValueText = new wxStaticText(this, ID_EDITPATCH_VALUE_TEXT, _("值:"), wxDefaultPosition, wxDefaultSize);
	...
	wxButton *EntryAdd = new wxButton(this, ID_ENTRY_ADD, _("添加"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	EntryRemove = new wxButton(this, ID_ENTRY_REMOVE, _("移除"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
	...
	wxButton* bOK = new wxButton(this, wxID_OK, wxT("确定"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
